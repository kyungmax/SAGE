...
INDEX_ROOT="${INDEX_ROOT:-${DARTH_INDEX_ROOT:-/home/kyungmin/vectordb/hnsw-playground/index/DARTH}}"
DATASET_ROOT="${DATASET_ROOT:-${DARTH_DATASET_ROOT:-/home/kyungmin/vectordb/hnsw-playground/datasets/processed/DARTH}}"
